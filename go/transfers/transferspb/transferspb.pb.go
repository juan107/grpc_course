...
func (x *TransfersRequest) Reset() {
	*x = TransfersRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_transferspb_proto_msgTypes[0]
...
func (*TransfersRequest) Descriptor() ([]byte, []int) {
	return file_transferspb_proto_rawDescGZIP(), []int{0}
}
...
func (x *TransfersResponse) Reset() {
	*x = TransfersResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_transferspb_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TransfersResponse) Descriptor() ([]byte, []int) {
	return file_transferspb_proto_rawDescGZIP(), []int{1}
}
...
var File_transferspb_proto protoreflect.FileDescriptor

var file_transferspb_proto_rawDesc = []byte{
	0x0a, 0x11, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x73, 0x70, 0x62, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x12, 0x09, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x73, 0x1a, 0x11,
...
var (
	file_transferspb_proto_rawDescOnce sync.Once
	file_transferspb_proto_rawDescData = file_transferspb_proto_rawDesc
)

func file_transferspb_proto_rawDescGZIP() []byte {
	file_transferspb_proto_rawDescOnce.Do(func() {
		file_transferspb_proto_rawDescData = protoimpl.X.CompressGZIP(file_transferspb_proto_rawDescData)
	})
	return file_transferspb_proto_rawDescData
}

var file_transferspb_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_transferspb_proto_goTypes = []interface{}{
...
var file_transferspb_proto_depIdxs = []int32{
...
func init() { file_transferspb_proto_init() }
func file_transferspb_proto_init() {
	if File_transferspb_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_transferspb_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_transferspb_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_transferspb_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_transferspb_proto_goTypes,
		DependencyIndexes: file_transferspb_proto_depIdxs,
		MessageInfos:      file_transferspb_proto_msgTypes,
	}.Build()
	File_transferspb_proto = out.File
	file_transferspb_proto_rawDesc = nil
	file_transferspb_proto_goTypes = nil
	file_transferspb_proto_depIdxs = nil
}
